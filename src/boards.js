...
[22, 33, 44, 55, 11, 12, 13, 58, 59, 60, 61, 32, 43, 54, 65, 6, 17, 28]];
const left_words = [[],[6, 16], [3, 128, 137], [3, 54, 24], [32, 73, 63, 4], [11, 58]];
const middle_words = [[],[7, 8, 17, 18], [4, 8, 129, 130, 131, 132, 133, 138, 139], [4, 5, 6, 55, 56, 25, 26], [33, 34, 35, 36, 37, 38, 74, 64, 5, 6],
[12, 59, 60]];
const right_words = [[],[9, 19], [5, 134, 140], [7, 57, 27], [39, 75, 65, 7], [13, 61]];
const top_words = [[],[], [90], [23], [], [22, 32, 6]]
const vert_middle_words = [[],[], [105, 120, 135], [35, 47], [], [33, 44, 43, 54, 17]]
const bottom_words = [[],[], [150], [59], [], [55, 65, 28]]
...
const answer = [
  ...
  ['S', 'null', 'T', 'null', 'F', 'O', 'A', 'M', 'null', 'A', 'I', 'T', 'E', 'A', 'M', 'null', 'I', 'C', 'E', 'S', 'null', 'N', 'R', 'null', 'B', 'U', 'I', 'L', 'T', 'null', 'C', 'null', 'V', 'I', 'T', 'null', 'L', 'null', 'null', 'I', 'M', 'A', 'G', 'E', 'P', 'O', 'E', 'T', 'null', 'C', 'O', 'A', 'L', 'null', 'S', 'E', 'N', 'V', 'I', 'R', 'O', 'N', 'M', 'E', 'N', 'T']
];
...
const starting_letters_ind = [
  ...
  [0, 5, 10, 12, 17, 19, 22, 24, 32, 39, 42, 45, 47, 51, 55, 59, 61, 65]
];
